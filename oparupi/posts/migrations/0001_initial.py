...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'posts_section', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('title', self.gf('django.db.models.fields.CharField')(max_length=50)),
        ))
        db.send_create_signal(u'posts', ['Section'])
        ...
        db.create_table(u'posts_post', (
            ...
            ('section', self.gf('django.db.models.fields.related.ForeignKey')(related_name='posts', to=orm['posts.Section'])),
    ...
    def backwards(self, orm):
        ...
        db.delete_table(u'posts_section')
