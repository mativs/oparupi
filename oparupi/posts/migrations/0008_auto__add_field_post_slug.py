...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'posts_post', 'slug',
                      self.gf('django.db.models.fields.SlugField')(default='', max_length=50, null=True, blank=True),
                      keep_default=False)
    ...
    models = {
        ...
        u'posts.post': {
            ...
            'slug': ('django.db.models.fields.SlugField', [], {'default': "''", 'max_length': '50', 'null': 'True', 'blank': 'True'}),
